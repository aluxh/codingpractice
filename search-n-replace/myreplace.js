...
Note
Preserve the case of the first character in the original word when you are replacing it. For example if you mean to replace the word "Book" with the word "dog", 
...
function myReplace(str, before, after) {
    ...
    let x = new RegExp(before);

    str = str.replace(x, after);
